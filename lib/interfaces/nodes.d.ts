...
export declare type NodeHelpersType = QueryCallbacksFor<typeof QueryMethods>['node'];
...
export declare type SerializedNode = Omit<NodeData, 'type' | 'subtype' | 'name' | 'event'> & ReducedComp;
